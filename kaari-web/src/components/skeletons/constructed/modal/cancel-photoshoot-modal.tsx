      ...
      <div className="modal-decline-reservation-container">
        <div className="content-container">
          ...
          <div className="text-container">
            <h2 className="title">Cancel Photoshoot</h2>
            <p className="description">
              You are trying to cancel a photoshoot.
          ...
          <PurpleButtonMB48 text="Cancel Photoshoot" onClick={handleDecline} disabled={!reason} />
