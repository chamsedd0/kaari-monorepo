...
interface DeclineReservationModalProps {
  isOpen: boolean;
  onClose: () => void;
  onDecline: (reason: string, proof?: File) => void;
}

const DeclineReservationModal: React.FC<DeclineReservationModalProps> = ({
  isOpen,
  onClose,
  onDecline
}) => {
      ...
      <div className="modal-decline-reservation-container">
        <div className="content-container">
          ...
          <div className="text-container">
            <h2 className="title">Decline Reservation</h2>
            <p className="description">
              You are trying to decline a reservation.
          ...
          <PurpleButtonMB48 text="Cancel Reservation" onClick={handleDecline} disabled={!reason} />
