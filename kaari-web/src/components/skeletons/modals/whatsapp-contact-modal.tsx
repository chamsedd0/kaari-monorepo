  ...
  return (
    <ModalOverlay onClick={onClose}>
      <ModalContainer onClick={(e) => e.stopPropagation()}>
        <ModalHeader>
          <ModalTitle>Contact via WhatsApp</ModalTitle>
          <CloseButton onClick={onClose}>&times;</CloseButton>
        </ModalHeader>
        
        <ModalContent>
          <TeamInfo>
            <p>You can contact <strong>{teamName}</strong> via WhatsApp:</p>
          </TeamInfo>
          ...
          <TeamInfo>
            <p>Click the button below to start a WhatsApp conversation with your assigned photographer.</p>
          </TeamInfo>
