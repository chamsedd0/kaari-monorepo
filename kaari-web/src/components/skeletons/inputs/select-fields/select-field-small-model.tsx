...
import { 
  ...
  Option,
  ChevronIcon
} from '../../../styles/inputs/select-fields/select-field-small-model-style';
...
const SelectFieldSmallModel: React.FC<SelectFieldProps> = ({
  options,
...
export default SelectFieldSmallModel;
