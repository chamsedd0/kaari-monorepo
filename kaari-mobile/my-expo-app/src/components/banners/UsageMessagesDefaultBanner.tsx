...
export default function UsageMessagesDefaultBanner() {
  return (
    <View className="flex-row items-center gap-3 px-3.5 py-3 rounded-2xl" style={{ backgroundColor: colors.white, borderWidth: 1, borderColor: colors.gray100 }}>
      ...
      <View className="flex-1">
        <Text className="text-gray700 font-extrabold">Messages</Text>
        <Text className="text-gray500 mt-0.5">See your latest messages and updates</Text>
      </View>
    </View>
  );
}
